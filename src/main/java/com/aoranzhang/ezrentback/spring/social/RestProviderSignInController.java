...
/*
 * This is an augmented class of the original spring ProviderSignInController
 */
...
public class RestProviderSignInController extends ProviderSignInController {
    ...
    public RestProviderSignInController(ConnectionFactoryLocator connectionFactoryLocator, UsersConnectionRepository usersConnectionRepository, SignInAdapter signInAdapter) {
    ...
    private RedirectView handleSignIn(Connection<?> connection, ConnectionFactory<?> connectionFactory, NativeWebRequest request) {
        ...
        if (userIds.size() == 0) {
            ...
            return originalUrl != null ? externalRedirect(originalUrl) : externalRedirect(postSignInUrl);
        } else {
    ...
    private RedirectView externalRedirect(String url) {
